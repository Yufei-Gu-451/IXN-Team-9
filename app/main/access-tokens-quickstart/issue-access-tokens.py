...
try:
	...
	# Create an identity
	# an identity will be created when the user1 access videocalling page
	...
	# The access token for the user1 would be generated
	...
	# an identity will be created when the user2 access videocalling page
	# The access token for the user1 would be generated
