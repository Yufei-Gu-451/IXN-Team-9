...
def upload():
  ...
  speech_to_text.speech_to_text(inputfile=os_file.get_root_dir() + os_file.get_sep() + 'app/audio/' + file.filename, \
    outputfile=os_file.get_root_dir() + os_file.get_sep() + "app/file/input.txt")

  text_summarizer.summarize_text(input_file=os_file.get_root_dir() + os_file.get_sep() + 'app/file/input.txt', \
    output_file=os_file.get_root_dir() + os_file.get_sep() + "app/file/output.txt", \
  ...
  summarized_file = open(os_file.get_root_dir() + os_file.get_sep() + "app/file/output.txt")
  ...
  transcribed_file = open(os_file.get_root_dir() + os_file.get_sep() + "app/file/input.txt")
