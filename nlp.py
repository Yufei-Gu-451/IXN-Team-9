...
text_summarizer.summarize_text(input_file='app/file/temp_input_2.txt', 
            output_file='app/file/temp_output.txt', compression_rate=0.2, number_of_clusters=4, algorithm_num=3)